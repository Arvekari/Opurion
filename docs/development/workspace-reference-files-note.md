# Workspace UI Reference Files

Date: 2026-03-10

Use the following files in this folder as the canonical visual reference examples for workspace layout and settings UI updates:
