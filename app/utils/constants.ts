import {
  ...
  CLIENT_PROVIDER_LIST,
  providerBaseUrlEnvKeys,
} from '~/lib/modules/llm/provider-metadata';
...
export const PROVIDER_LIST = CLIENT_PROVIDER_LIST;
export const DEFAULT_PROVIDER = CLIENT_DEFAULT_PROVIDER;
export { providerBaseUrlEnvKeys };
